  ...
  return (
    <div className={`flex items-center justify-between px-4 py-2 rounded-md ${bgColor}`}>
      <div className="flex items-center gap-3">
        <img src={avatar} alt="Avatar" className="w-9 h-9 rounded-full object-cover border" />
        <div>
      ...
      <span
        className={`flex items-center gap-1 px-3 py-1 rounded-full text-white text-xs font-semibold ${badgeColor}`}
      >
